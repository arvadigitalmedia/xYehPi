<?php
/**
 * EPIC Hub - Products List Template
 */
...
<head>
    ...
    <title><?= htmlspecialchars($page_title ?? 'Products - EPIC Hub') ?></title>
    <meta name="description" content="<?= htmlspecialchars($page_description ?? 'Temukan berbagai produk digital berkualitas tinggi') ?>">
                    ...
                    <?php foreach ($products as $product): ?>
                        <div class="bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition-shadow">
                            ...
                            <div class="p-6">
                                ...
                                <p class="text-gray-600 mb-4"><?= htmlspecialchars($product['short_description'] ?? $product['description'] ?? '') ?></p>
