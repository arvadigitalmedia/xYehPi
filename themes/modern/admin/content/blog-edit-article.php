...
/**
 * Edit Article Form
 * WordPress-style article editing with SEO optimization
 */
...
$social_image = $gallery_data['social_image'] ?? '';
?>
            ...
            <div class="form-section">
                <div class="form-group">
                    ...
                    <textarea name="content" id="articleContent" class="form-textarea content-editor" 
                              ...
                              rows="20" required><?= htmlspecialchars($_POST['content'] ?? $article['content']) ?></textarea>
                    <div class="editor-stats">
                        <span id="wordCount">0 words</span>
                        <span id="readingTime"><?= $article['reading_time'] ?? 0 ?> min read</span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                <div class="form-group">
                    ...
                    <textarea name="excerpt" id="articleExcerpt" class="form-textarea" 
                              ...
                              rows="3" maxlength="500"><?= htmlspecialchars($_POST['excerpt'] ?? $article['excerpt']) ?></textarea>
                    <div class="form-help">
                ...
                <div class="section-body">
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="info-value"><?= date('M j, Y g:i A', strtotime($article['created_at'])) ?></div>
                        </div>
                        
                        <?php if ($article['updated_at'] && $article['updated_at'] !== $article['created_at']): ?>
                            <div class="info-item">
                                <div class="info-label">Last Updated</div>
                                <div class="info-value"><?= date('M j, Y g:i A', strtotime($article['updated_at'])) ?></div>
                            </div>
                        <?php endif; ?>
                        
                        <div class="info-item">
                            <div class="info-label">Views</div>
                            <div class="info-value"><?= number_format($article['view_count']) ?></div>
                        </div>
                        
                        <?php if ($article['published_at']): ?>
                            <div class="info-item">
                                <div class="info-label">Published</div>
                                <div class="info-value"><?= date('M j, Y g:i A', strtotime($article['published_at'])) ?></div>
                            </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="section-body">
                    <div class="form-group">
                        ...
                        <select name="status" class="form-select">
                            ...
                            <option value="private" <?= ($_POST['status'] ?? $article['status']) === 'private' ? 'selected' : '' ?>>Private</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="visibility" class="form-select">
                            <option value="public" <?= ($_POST['visibility'] ?? $article['visibility']) === 'public' ? 'selected' : '' ?>>Public</option>
                            <option value="members" <?= ($_POST['visibility'] ?? $article['visibility']) === 'members' ? 'selected' : '' ?>>Members Only</option>
                            <option value="premium" <?= ($_POST['visibility'] ?? $article['visibility']) === 'premium' ? 'selected' : '' ?>>Premium Only</option>
                        </select>
                    </div>
                    ...
                    <div class="image-upload-area" id="imageUploadArea">
                        <?php if ($article['featured_image']): ?>
                            <div class="image-preview" id="imagePreview">
                                <img id="previewImage" src="<?= epic_url('uploads/' . $article['featured_image']) ?>" alt="Featured Image">
                ...
                <div class="section-body">
                    <div class="form-group">
                        ...
                        <input type="url" name="social_image" id="socialImage" class="form-input" 
                               ...
                               value="<?= htmlspecialchars($_POST['social_image'] ?? $social_image) ?>">
                    ...
                    <div class="social-preview" id="socialPreview">
                        ...
                        <div class="preview-card">
                            <div class="preview-image" id="previewSocialImage">
                                <?php if ($social_image): ?>
                                    <img src="<?= htmlspecialchars($social_image) ?>" alt="Social preview">
                                <?php else: ?>
                                    <i data-feather="image" width="24" height="24"></i>
                                <?php endif; ?>
                            </div>
                            <div class="preview-content">
                                <div class="preview-title" id="previewTitle"><?= htmlspecialchars($article['title']) ?></div>
                                <div class="preview-description" id="previewDescription"><?= htmlspecialchars($article['excerpt'] ?: 'Article excerpt will appear here...') ?></div>
                ...
                <div class="section-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="seo_title" id="seoTitle" class="form-input" 
                               ...
                               value="<?= htmlspecialchars($_POST['seo_title'] ?? $article['seo_title']) ?>" 
                               maxlength="60">
                        <div class="form-help">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="seo_description" id="seoDescription" class="form-textarea" 
                                  ...
                                  rows="3" maxlength="160"><?= htmlspecialchars($_POST['seo_description'] ?? $article['seo_description']) ?></textarea>
                        <div class="form-help">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="seo_keywords" id="seoKeywords" class="form-input" 
                               ...
                               value="<?= htmlspecialchars($_POST['seo_keywords'] ?? $article['seo_keywords']) ?>">
                    ...
                    <div class="seo-preview">
                        ...
                        <div class="search-result-preview">
                            <div class="result-url">epicHub.com/blog/<span id="previewSlug"><?= htmlspecialchars($article['slug']) ?></span></div>
                            <div class="result-title" id="resultTitle"><?= htmlspecialchars($article['seo_title'] ?: $article['title']) ?></div>
                            <div class="result-description" id="resultDescription"><?= htmlspecialchars($article['seo_description'] ?: $article['excerpt'] ?: 'Article description will appear here...') ?></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="form-actions">
        ...
        <div class="actions-right">
            ...
            <button type="submit" name="status" value="published" class="btn btn-primary">
                ...
                <?= $article['status'] === 'published' ? 'Update' : 'Publish' ?> Article
            </button>
        </div>
    </div>
</form>
...
<style>
/* Include the same styles from blog-add-article.php */
.article-form {
    max-width: none;
}
...
<script>
// Use the same ArticleEditor class from add article
...
class ArticleEditor {
    ...
    updateCharCounts() {
        this.updateCharCount('excerptCount', this.excerptInput, 500);
        this.updateCharCount('seoTitleCount', this.seoTitle, 60);
        this.updateCharCount('seoDescCount', this.seoDescription, 160);
    }
...
// Editor functions (same as add article)
...
function deleteArticle() {
    if (confirm('Are you sure you want to delete this article? This action cannot be undone.')) {
        window.location.href = '<?= epic_url('admin/blog?action=delete&id=' . $article['id']) ?>';
    }
}
