<?php
/**
 * EPIC Hub Admin - Member Area Products Content
 * Konten halaman Member Area Products yang dapat diakses dari admin dengan desain responsif
 */
...
$products_data = [
    'my_products' => rand(2, 8),
    'free_products' => rand(3, 6),
    'premium_products' => rand(8, 15),
    'total_products' => rand(15, 25),
    'access_level' => 'EPIC Account'
];
?>
    ...
    <div class="dashboard-header">
        <div class="header-content">
            <div class="header-title">
                ...
                <p class="page-subtitle">Kelola akses produk member berdasarkan jenis akun dan pembelian</p>
            </div>
            
            <div class="header-actions">
                <a href="<?= epic_url('dashboard/member/products') ?>" target="_blank" class="btn btn-primary">
    ...
    <div class="products-overview">
        <div class="overview-grid">
            <div class="overview-card">
                <div class="card-icon my-products">
                    <i data-feather="check-circle"></i>
                </div>
                <div class="card-content">
                    <h3 class="card-value"><?= $products_data['my_products'] ?></h3>
                    <p class="card-label">My Products</p>
                </div>
            </div>
            
            <div class="overview-card">
                <div class="card-icon free-products">
                    <i data-feather="gift"></i>
                </div>
                <div class="card-content">
                    <h3 class="card-value"><?= $products_data['free_products'] ?></h3>
                    <p class="card-label">Free Products</p>
                </div>
            </div>
            
            <div class="overview-card">
                <div class="card-icon premium-products">
                    <i data-feather="star"></i>
                </div>
                <div class="card-content">
                    <h3 class="card-value"><?= $products_data['premium_products'] ?></h3>
                    <p class="card-label">Premium Products</p>
                </div>
            </div>
            ...
            <div class="overview-card">
                ...
                <div class="card-content">
                    <h3 class="card-value"><?= $products_data['total_products'] ?></h3>
        ...
        <div class="features-grid">
                ...
                <div class="features-list">
                    <div class="feature-item">
                        ...
                        <div class="feature-content">
                            <h4>Kategorisasi Produk</h4>
                            <p>My Products, Free Products, Premium Products</p>
                        </div>
                    </div>
                    ...
                    <div class="feature-item">
                        ...
                        <div class="feature-content">
                            ...
                            <p>Pembatasan akses berdasarkan jenis akun</p>
                        </div>
                    </div>
                    ...
                    <div class="feature-item">
                        ...
                        <div class="feature-content">
                            <h4>Direct Access</h4>
                            <p>Akses langsung ke produk yang sudah dibeli</p>
                        </div>
                    </div>
                    ...
                    <div class="feature-item">
                        ...
                        <div class="feature-content">
                            <h4>Premium Preview</h4>
                            <p>Preview produk premium untuk Free users</p>
                        </div>
                    </div>
                    ...
                    <div class="feature-item">
                        ...
                        <div class="feature-content">
                            <h4>Upgrade CTA</h4>
                            <p>Call-to-action untuk upgrade ke EPIC Account</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="access-control-section">
                <h3 class="section-title">
                    ...
                    Kontrol Akses Produk
                </h3>
                <div class="access-levels">
                    <div class="access-level epic-access">
                        ...
                        <div class="access-features">
                            <p>✓ Akses ke semua produk premium</p>
                    ...
                    <div class="access-level free-access">
                        <div class="access-header">
                            <div class="access-icon">
                                <i data-feather="gift"></i>
                            </div>
                        ...
                        <div class="access-features">
                            <p>✓ Akses produk gratis terbatas</p>
                            <p>✓ Preview produk premium</p>
                            <p>✓ Basic support</p>
                            <p>⚠ Upgrade required untuk full access</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="preview-instructions">
        <div class="instruction-card">
            ...
            <div class="instruction-content">
                <h4>Cara Mengakses Preview Akses Produk</h4>
                <p>Gunakan kolom pencarian di atas untuk mencari nama member, lalu pilih member yang ingin Anda preview. Setelah memilih member, Anda dapat melihat sistem akses produk berdasarkan jenis akun dan pembelian.</p>
            </div>
        </div>
    </div>
...
.card-icon.my-products {
    background: linear-gradient(135deg, #10b981, #047857);
}

.card-icon.free-products {
    background: linear-gradient(135deg, #3b82f6, #1d4ed8);
}

.card-icon.premium-products {
...
.epic-access .access-icon {
    background: linear-gradient(135deg, #10b981, #047857);
}

.free-access .access-icon {
...
function previewMember(memberId) {
    if (memberId) {
        ...
        const currentUrl = new URL(window.location);
        currentUrl.searchParams.delete('member_id');
        window.location.href = currentUrl.toString();
    }
}
