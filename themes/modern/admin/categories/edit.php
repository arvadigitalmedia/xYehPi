...
<div class="admin-content">
                <div class="content-header">
                    <div class="header-left">
                        <h1 class="page-title">
                            <i data-feather="edit" class="page-icon"></i>
                            Edit Category
                        </h1>
                                    ...
                                    <div class="section-body">
                                        <div class="info-grid">
                                            <div class="info-item">
                                                ...
                                                <div class="info-value"><?= date('M j, Y g:i A', strtotime($category['created_at'])) ?></div>
                                            </div>
                                            
                                            <?php if ($category['updated_at'] && $category['updated_at'] !== $category['created_at']): ?>
                                                <div class="info-item">
                                                    <div class="info-label">Last Updated</div>
                                                    <div class="info-value"><?= date('M j, Y g:i A', strtotime($category['updated_at'])) ?></div>
                                                </div>
                                            <?php endif; ?>
                                            
                                            <div class="info-item">
                                                <div class="info-label">Current Slug</div>
                                                <div class="info-value"><?= htmlspecialchars($category['slug']) ?></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="section-body">
                                        <div class="category-preview">
                                            <div class="preview-item">
                                                ...
                                                <div class="preview-value" id="previewName"><?= htmlspecialchars($category['name']) ?></div>
                                            </div>
                                            <div class="preview-item">
                                                <div class="preview-label">New Slug:</div>
                                                <div class="preview-value" id="previewSlug"><?= htmlspecialchars($category['slug']) ?></div>
                                            </div>
                                            <div class="preview-item">
...
<script>
    ...
    function updatePreview() {
        ...
        const name = nameInput.value || '<?= htmlspecialchars($category['name']) ?>';
        const slug = generateSlug(name);
        const status = statusSelect.value;
        
        document.getElementById('previewName').textContent = name;
        document.getElementById('previewSlug').textContent = slug || '<?= htmlspecialchars($category['slug']) ?>';
    ...
    function deleteCategory() {
        if (confirm('Are you sure you want to delete this category? This action cannot be undone.')) {
            window.location.href = '<?= epic_url('admin/categories?action=delete&id=' . $category['id']) ?>';
        }
    }
